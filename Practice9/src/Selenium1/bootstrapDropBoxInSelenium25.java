...
public class bootstrapDropBoxInSelenium25 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement dropBtn = driver.findElement(By.xpath("//button[@id='dropdownMenuButton']"));
		scrollPerticular(dropBtn, driver);
		clickBtn(dropBtn, driver);
		Thread.sleep(3000);
